...
| hover 抬升與「基準值要快照」的實戰重演:抬升前快照 position + 旗標防重複——抬升中再 hover 若讀當下 position 當基準,會越抬越高(和 original_scale 同一族 bug,這次寫進 animate_hover) | 初階/未驗 | 「_hover_lifted 旗標拿掉會發生什麼?為什麼 unhover 要 tween 回快照而不是 tween position.y -= HOVER_LIFT?」 |
