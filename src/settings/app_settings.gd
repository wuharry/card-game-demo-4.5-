...
const ZH := {
	...
	"battle_attack": "攻擊",
	"battle_history": "戰鬥紀錄",
	"battle_history_empty": "行動提示會保留在這裡。",
	"battle_skill": "技能",
	"battle_cancel": "取消",
	"battle_end_turn": "結束\n回合",
	"battle_wait_turn": "等待\n對手",
	...
	"battle_my_turn": "我方回合",
	"battle_mana_own": "我方魔力",
	"battle_mana_enemy": "對方魔力",
	"battle_temp_mana": "暫時 +%d · 回合末消失",
	"battle_mana_delta": "魔力 %s%d",
	"battle_status_turns": "%s · %d 回合",
	"battle_attack_spent": "攻擊已使用",
	"battle_skill_spent": "技能已使用",
...
const EN := {
	...
	"battle_history_empty": "Action messages will appear here.",
	"battle_skill": "Skill",
	"battle_cancel": "Cancel",
	"battle_end_turn": "End\nTurn",
	"battle_wait_turn": "Enemy\nTurn",
	"battle_leave": "Leave",
	...
	"battle_mana_own": "Your Mana",
	"battle_mana_enemy": "Opponent Mana",
	"battle_temp_mana": "Temporary +%d · expires this turn",
	"battle_mana_delta": "Mana %s%d",
	"battle_status_turns": "%s · %d turn(s)",
	"battle_attack_spent": "Attack used",
	"battle_skill_spent": "Skill used",
