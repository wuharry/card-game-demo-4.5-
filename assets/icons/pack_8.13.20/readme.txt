...
The download now has a new folder "updated layout". This set has a slightly different organization of the icons so that the buff/debuff icons work nicely with RPG-MAKER's expected default setup.

The updated layout also includes some new icons to fill in the space: some additional food icons (hot dog, taco, milk, water bottle, etc) and an additional row of weapon icons for warhammers.

The 'quick_guide.png' should still be generally accurate to the overall layout, the only change is that there have been some additional rows added here and there.
